...
public class Board {
    ...
    public void initialise() {
        ...
        //Property(String name, int price, int rent,String group)
    ...
    public void printBoard() {
        ...
        for (int row = 0; row < 11; row++) {
            for (int col = 0; col < 11; col++) {
                for (int line = 0; line < 8; line++) {
                    boardGrid[row][col][line] = "        "; // Empty space
                }
            }
        }
        ...
        for (int i = 0; i < SIZE; i++) {
            ...
            // Set the content at the correct grid position
            if (row >= 0 && col >= 0) {
        ...
        for (int row = 0; row < 11; row++) {
            ...
            for (int line = 0; line < 8; line++) {
                for (int col = 0; col < 11; col++) {
                    ...
                    System.out.print("x" + content); // Print tile content
                }
